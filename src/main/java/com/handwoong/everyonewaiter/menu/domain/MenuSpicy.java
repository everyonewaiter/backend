...
public record MenuSpicy(int value) {
	...
	public static final String MENU_SPICY_MAX_VALUE_MESSAGE = "메뉴의 맵기는 0이상 10이하로 입력해주세요.";
	public static final int MIN_SPICY = 0;
	public static final int MAX_SPICY = 10;

	public MenuSpicy {
		if (value < MIN_SPICY || value > MAX_SPICY) {
			throw new InvalidMenuSpicySizeException(MENU_SPICY_MAX_VALUE_MESSAGE, value);
		}
	}
